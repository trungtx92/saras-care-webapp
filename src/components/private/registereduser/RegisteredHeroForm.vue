    ...
    <div v-show="step === 1">
      ...
      <div class="row form-group">
        <div class="col-12">
          ...
          <b-field>
            <b-input maxlength="6" type="number" v-model="postcode" placeholder="Postcode"></b-input>
          </b-field>
          ...
          <div class="row">
            ...
            <div class="result col-12">
              <div class="row">
                ...
                <div class="right col-12 col-md-6">{{ this.caseDate }}</div>
              </div>
              <div class="row">
                <div class="left col-12 col-md-6">Offense Time:</div>
                <div class="right col-12 col-md-6">{{ this.caseTime }}</div>
              </div>
...
import myCaptcha from "@/components/customComponents/vue-captcha.vue";
...
export default {
  ...
  mounted() {
    console.log("Registerd User HeroForm component mounted.");
  ...
  methods: {
    ...
    next() {
      this.name= this.$parent.$parent.mainName;
      this.phone= this.$parent.$parent.loggedin.phone;
      this.email=this.$parent.$parent.loggedin.email;
    ...
    postOffenseEvidence(cParent) {
      ...
      for (var i = 0; i < this.files.length; i++) {
        ...
        var filename = { name: file.name, parent_id: cParent};
    ...
    postOffense() {
      ...
      return axios.post(this.url, {
        offenseDate: Number.isInteger(t)? this.caseDate + " " + this.caseTime : null,
